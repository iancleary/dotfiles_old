...
module.exports = {
  config: {
    ...
    fontFamily: '"MesloLGS NF", "JetBrains Mono", "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',
  ...
  //   `@company/project`
  //   `project#1.0.1`
    plugins: ["hyper-one-dark", "hyper-font-ligatures", "hyper-active-tab", "hyper-samewd"],
